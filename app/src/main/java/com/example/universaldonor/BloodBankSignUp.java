                ...
                .addOnCompleteListener(getActivity(), new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            BloodBank bloodBank = new BloodBank("Random Bank",bloodStats,donations,-1,SignupActivity.latitude,SignupActivity.longitude,address,city,state.toString(),tempEmail);
